    ...
    <header id="header" class="ex-2-header">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h1>Daftar</h1>
                   <p>Isi formulir di bawah ini untuk mendaftar Calm. Sudah mendaftar? Kemudian cukup <a class="white" href="login.php">Masuk</a></p> 
                    <!-- Sign Up Form -->
                    <div class="form-container">
                        <form class="form-container" action="register.php" method="POST">
                            ...
                            <div class="form-group">
                                <input type="email" class="form-control-input" id="InputEmail" name="email" aria-describeby="emailHelp">
                            ...
                            <div class="form-group">
                                <input type="password" class="form-control-input" id="InputRePassword" name="repassword">
                                <label class="label-control" for="InputPassword">Kata sandi ulang</label>
                                <?php if($validate != '') {?>
                                    <p class="text-danger"><?= $validate; ?></p>
                                <?php }?>
                                <div class="help-block with-errors"></div>
                            ...
                            <div class="form-group">
                                <button type="submit" name="submit" class="form-control-submit-button">DAFTAR</button>
                            </div>
