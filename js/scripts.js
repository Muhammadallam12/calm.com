...
(function ($) {
  ...
  $("body").prepend(
    ...
    <div class="chat-title">
      ...
      <h2>Sedang Galau</h2>
      <figure class="avatar">
        <img src="https://www.pikpng.com/pngl/m/557-5578161_image-set-png-256x256-px-chat-icon-chat.png" />
      </figure>
    </div>
    <div class="messages">
  ...
  $("body").prepend(
    '<a class="chat-button">Chat Box</a>'
  ); /* Removes Long Focus On Buttons */
  var amountScrolled = 700;
  $(window).scroll(function () {
    if ($(window).scrollTop() > amountScrolled) {
      $("a.chat-button").css("bottom", "3.75rem");
    } else {
      $("a.chat-button").css("bottom", "0.75rem");
    }
  });
