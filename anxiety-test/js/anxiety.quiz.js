...
const questions = [
  {
    question: "1. Jantung Berdebar",
    score: 0,
  },
  {
    question: "2. Berkeringat",
    score: 0,
  },
  {
    question: "3. Tremor atau Gemetar",
    score: 0,
  },
  {
    question: "4. Sesak Napas",
    score: 0,
  },
  {
    question: "5. Khawatir atau takut",
    score: 0,
  },
  {
    question: "6. Nyeri dada atau Tidak nyaman",
    score: 0,
  },
  {
    question: "7. Mual atau gangguan perut",
    score: 0,
  },
  {
    question: "8. Merasa pusing atau goyah",
    score: 0,
  },
  {
    question: "9. Takut kehilangan kendali atau menjadi gila",
    score: 0,
  },
  {
    question: "10. Sensasi mati rasa atau kesemutan",
    score: 0,
  },
  {
    question: "11. Menggigil",
    score: 0,
  },
  {
    question: "12. Takut mati",
    score: 0,
  },
  {
    question: "13. Kekhawatiran konstan atau terus-menerus",
    score: 0,
  },
  {
    question: "14. Perasaan tersedak",
    score: 0,
  },
  {
    question: "15. Tidak bisa santai",
    score: 0,
  },
  {
    question: "16. Perasaan tidak nyata",
    score: 0,
  },
  {
    question: "17. Grogi",
  ...
  {
    question: "18. Merasa goyah",
    score: 0,
  },
  {
    question: "19. Mudah tersinggung atau sulit tidur",
    score: 0,
  },
  {
    question: "20. Tangan gemetar",
    score: 0,
  },
  {
    question: "21. Saya menghindari situasi karena kecemasan",
    score: 0,
  },
  {
    question: "22. Merasa pusing atau pingsan",
    score: 0,
  },
];
let i = 0;
...
checkResult.addEventListener("click", () => {
  ...
  if (score >= -1 && score <= 5) {
    container1.append(`
        <h1>Tidak Ada Kecemasan</h1>
        <h2>Skor Adalah ${score}</h2>
        <h3>Hasil Kuis Penyaringan Kecemasan Anda </h3>
        <p>Anda telah menjawab skrining kecemasan ini sedemikian rupa untuk menunjukkan bahwa Anda saat ini tidak mungkin menderita gangguan kecemasan. Namun, tingkat kecemasan yang kecil ini sebenarnya bisa menjadi tanda kecemasan dalam hidup Anda. Individu yang mendapat skor dalam kisaran rendah ini terkadang menunjukkan bahwa mereka mungkin terlepas dari diri mereka sendiri, orang lain, atau lingkungan mereka. Biasanya ini tidak sehat untuk sebagian besar dan harus dihindari. Anda dapat membantu diri Anda sendiri dengan melakukan upaya yang lebih terpadu untuk terikat kembali dengan orang-orang penting dan lingkungan Anda. </p>
        `);
  } else if (score >= 6 && score <= 22) {
    container1.append(`
        <h1>Kecemasan sedikit hingga sedang</h1>
        <h2>Skor Adalah ${score}</h2>
        <h3>Hasil Kuis Penyaringan Kecemasan Anda </h3>
        <p>Anda telah menjawab skrining kecemasan ini sedemikian rupa untuk menunjukkan bahwa Anda saat ini tidak mungkin menderita gangguan kecemasan. Ingatlah bahwa sedikit kecemasan dalam kehidupan sehari-hari yang normal diharapkan dan merupakan hal yang baik. Tidak seorang pun boleh tanpa kecemasan apa pun, karena kecemasan adalah cara tubuh kita memberi tahu kita bahwa kita harus lebih memperhatikan situasi, peristiwa, atau orang dalam hidup kita (bahkan jika orang itu adalah diri kita sendiri). Skor dalam kisaran ini menunjukkan bahwa Anda memiliki tingkat kecemasan yang normal tetapi kemungkinan besar tidak memenuhi syarat untuk diagnosis gangguan kecemasan. </p>
        `);
  } else if (score >= 23 && score <= 37) {
    container1.append(`
        <h1>Kecemasan Sedang</h1>
        <h2>Skor Adalah ${score}</h2>
        <h3>Hasil Kuis Penyaringan Kecemasan Anda </h3>
        <p>Berdasarkan tanggapan Anda terhadap tindakan skrining kecemasan ini, tampaknya Anda mungkin menderita kecemasan sedang, gejala yang biasanya membuat Anda memenuhi syarat untuk diagnosis gangguan kecemasan.<br><br>
        Terkadang orang yang merasakan gejala kecemasan seperti itu tidak menyadari bahwa tubuh mereka mungkin mencoba memberi tahu mereka sesuatu. Cari pola dalam perilaku Anda, seperti kapan dan keadaan apa di mana Anda mengalami gejala yang telah Anda gambarkan. Misalnya, jika itu terjadi sebelum berbicara di depan umum dan pekerjaan Anda membutuhkan banyak presentasi, Anda mungkin ingin mencari cara untuk menenangkan diri sebelum berbicara atau membiarkan orang lain melakukan beberapa presentasi. </p>    
        `);
  } else if (score >= 38) {
    container1.append(`
        <h1>Kecemasan parah</h1>
        <h2>Skor Adalah ${score}</h2>
        <h3>Hasil Kuis Penyaringan Kecemasan Anda </h3>
        <p>Berdasarkan tanggapan Anda terhadap tindakan skrining ini , Tanggapan Anda serupa dengan orang lain yang mengalami gejala kecemasan parah.<br>Sebaiknya pertimbangkan untuk menghubungi profesional yang berkualifikasi tentang gejala Anda.</p>
        `);
  }
});
...
//     container1.append(`
//     <h1>No Anxiety</h1>
//     <h2>Skor Adalah ${scoreAnxiety}</h2>
//     <h3>Hasil Kuis Penyaringan Kecemasan Anda </h3>
...
//     <h2>Your Skor Adalah ${scoreAnxiety}</h2>
//     <h3>Hasil Kuis Penyaringan Kecemasan Anda </h3>
